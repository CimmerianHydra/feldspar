...
use crate::content::recipe::SpatialRecipeRegistry;
use crate::sim::crafting::machine::*;
use crate::sim::inventory::cursor::CursorInventory;
use crate::sim::inventory::spatial::{
    SpatialChange, SpatialInventory, SpatialInventoryChangedEvent,
};
...
pub fn spatial_inventory_change_recompute_recipe_obs(
    ...
    current.0 = recipes.match_layout(&inv_data.layout());
