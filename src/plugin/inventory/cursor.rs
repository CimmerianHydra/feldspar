...
use crate::plugin::ui::crafting::SpatialInventoryClickedEvent;
...
/// Data-side twin of `inventory_ui_click_obs`: consumes a resolved click
/// and performs all cursor <-> spatial-inventory exchanges. Never touches
/// UI; the change events it fires drive the visual sync.
///
...
pub fn spatial_inventory_ui_click_obs(
