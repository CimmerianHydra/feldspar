...
use crate::plugin::{inventory::main::*, loader::item_registry::{ItemID, ItemRegistry}};
...
impl SpatialInventory {
    ...
    /// order-sensitive (the future recognizer) must not depend on it.
