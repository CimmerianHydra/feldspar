...
use crate::plugin::geometry::element::{box_quads, BakedQuad, Element};
use crate::plugin::geometry::rotation::{dir_index, BlockRotation, ALL_DIRECTIONS};
use crate::plugin::geometry::voxel::Direction;

// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// SECTION 1 – IDS AND MODELS
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
/// allocation, no hashing, no `Vec<Quad>` churn — which is what
/// `shape_quads` currently does for every non-air voxel on every remesh.
...
fn rotate_quad(q: &mut BakedQuad, r: BlockRotation) {
    ...
    if let Some(d) = q.cull.dir() {
        q.cull = crate::plugin::geometry::element::CullTag::from_dir(r.apply_dir(d));
    }
...
///
/// This replaces `Voxel::covers_face`, which was a hand-written match per
/// `BlockShape`. Hand-writing it does not survive contact with imported
/// models — nobody can eyeball whether a Blockbench mesh happens to tile
/// its north boundary. So: rasterise instead.
///
